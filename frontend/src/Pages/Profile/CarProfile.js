...
const CarProfile = () => {
    ...
    return (
        <div className="p-4">
            {carStats && (
                <div className="mb-4">
                    <h4 className="fw-bold mb-4 text-center">Thống kê xe</h4>
                    <div className="row">
                            ...
                            <div className="card text-center shadow-sm">
                                <div className="card-body">
                                    ...
                                    {carStats.maxPriceCarName ? (
                                        <>
                                            <div><strong>{carStats.maxPriceCarName}</strong></div>
            ...
            {cars.length === 0 ? (
                ...
                <Table striped bordered hover responsive className="align-middle text-center mt-4">
                    <thead>
                        <tr>
                            <th>Tên xe</th>
                            <th>Biển số</th>
