  ...
  return (
    <div className="">
      <Container className="py-2 border">
        <h2 className="fw-bold mb-3 ps-3">{car.carname}</h2>
        ...
        <Row>
          ...
          <Col md={6}>
            <div className="p-4 border rounded shadow-sm h-100">
              ...
              <Button
                className="w-100 mt-4 mb-3 button-datxe"
              ...
              <div>
                <p className="text-center text-contract">
                    ...
                    <div className="border rounded shadow-sm h-100">
                      ...
                      <div className="p-2">
                        ...
                        <p className="mb-0 text-muted">
                          {item.price_per_date.toLocaleString()}đ/ngày
                        </p>
                        <p className="mb-0 text-muted">
